...
<script>
function facilitySchedule(startDay,endDay) {
fetch("facilitySchedule?startDay="+startDay+"&endDay="+endDay)
.then(function(res) {
	return res.json();
})
.then(function(res) {
	...
	<body onload="facilitySchedule(null,null)">
	   <div id="content">
	     <!-- Begin Page Content -->
		...
		<form>
			<table border="1" class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
				...
				<tbody id="tbody">
				<tr>
				<td rowspan="1" nowrap="nowrap"><span>10/31</span><a href="#">
